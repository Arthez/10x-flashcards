  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex justify-center gap-8 text-sm text-muted-foreground">
        <span className={!isFlipped ? "underline underline-offset-4 font-medium text-foreground" : ""}>Front</span>
        <span className={isFlipped ? "underline underline-offset-4 font-medium text-foreground" : ""}>Back</span>
      </div>
